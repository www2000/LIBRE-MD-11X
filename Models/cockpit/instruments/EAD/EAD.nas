...
setlistener("sim/signals/fdm-initialized", func {
	...
	EAD_GE = canvas_EAD_GE.new(group_EAD_GE, "Aircraft/LIBRE-MD-11/Models/cockpit/instruments/EAD/res/ge.svg");
	EAD_PW = canvas_EAD_PW.new(group_EAD_PW, "Aircraft/LIBRE-MD-11/Models/cockpit/instruments/EAD/res/pw.svg");
